...
uses
  ...
  RxMemDS, FR_Class, FR_DSet, FR_DBSet, FR_ChBox, FR_Rich;
...
type
  TFCardDelivery = class(TForm)
    ...
    frCheckBoxObject2: TfrCheckBoxObject;
...
begin
        ...
        RxMemoryData1.FieldByName('KLN_SEX').asString:='';
        if ( RadioButton1.checked)then RxMemoryData1.FieldByName('KLN_SEX').asString:= 'М';
        if ( RadioButton2.checked)then RxMemoryData1.FieldByName('KLN_SEX').asString:= 'Ж';
