object REPORT_MARKETKONK: TREPORT_MARKETKONK
  Left = 83
  Top = 132
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Отчёт о товарах, имеющих ценовых конкурентов'
  ClientHeight = 137
  ClientWidth = 503
  Color = clBtnFace
  ...
  object BtnGroup: TSpeedButton
    ...
    Width = 23
    Height = 22
    Hint = 'Выбрать группу товаров (F11)'
    Enabled = False
    Glyph.Data = {
  ...
  object Label2: TLabel
    ...
    Width = 262
    Height = 13
    Caption = 'Цены у конкурентов ниже, чем наши, более чем на '
  end
  ...
  object PipMarketKonk: TppDBPipeline
    DataSource = DataModule2.DsKonk
    UserName = 'PipMarketKonk'
    Left = 204
    object PipMarketKonkppField1: TppField
      FieldAlias = 'TW_ART'
      FieldName = 'TW_ART'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipMarketKonkppField2: TppField
      FieldAlias = 'TW_NAM'
      FieldName = 'TW_NAM'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipMarketKonkppField3: TppField
    ...
    object PipMarketKonkppField4: TppField
      FieldAlias = 'ED_SHORT'
      FieldName = 'ED_SHORT'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipMarketKonkppField5: TppField
      FieldAlias = 'TW_MONEY'
      FieldName = 'TW_MONEY'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipMarketKonkppField6: TppField
    ...
    object PipMarketKonkppField7: TppField
      FieldAlias = 'MTW_MONEY'
      FieldName = 'MTW_MONEY'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
    ...
    object PipMarketKonkppField8: TppField
      FieldAlias = 'MTW_MONEYD'
    ...
    object PipMarketKonkppField9: TppField
    ...
    object PipMarketKonkppField10: TppField
    ...
    object PipMarketKonkppField11: TppField
      FieldAlias = 'KLN_FULL'
      FieldName = 'KLN_FULL'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipMarketKonkppField12: TppField
      FieldAlias = 'US_FULL'
      FieldName = 'US_FULL'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipMarketKonkppField13: TppField
      FieldAlias = 'TW_OST'
      FieldName = 'TW_OST'
      FieldLength = 0
      DataType = dtNotKnown
  ...
  object PpKonk: TppReport
    AutoStop = False
    DataPipeline = PipMarketKonk
    PassSetting = psTwoPass
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Отчет о товарах, имеющих ценовых конкурентов'
  ...
  object QrRntyp: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'select rntyp_full,rntyp_id,'
      
        '((select max(kurs.kurs_kurs)  from kurs where kurs.valuta_id=1 a' +
        'nd kurs.kurs_typ=0 and kurs.kurs_date= '
      
        '       (select max(kurs_date) from kurs where kurs.valuta_id=1 a' +
        'nd kurs.kurs_typ=0))-(select max(kurs.kurs_kurs)  from kurs wher' +
        'e kurs.valuta_id=1 and kurs.kurs_typ=-rntyp.rntyp_id and kurs.ku' +
        'rs_date= '
      
        '       (select max(kurs_date) from kurs where kurs.valuta_id=1 a' +
        'nd kurs.kurs_typ=-rntyp.rntyp_id)))/'
      
        '((select max(kurs.kurs_kurs)  from kurs where kurs.valuta_id=1 a' +
        'nd kurs.kurs_typ=0 and kurs.kurs_date= '
      
        '       (select max(kurs_date) from kurs where kurs.valuta_id=1 a' +
        'nd kurs.kurs_typ=0))/100) as percent'
      '  from rntyp'
      'order by rntyp_id')
    Left = 336
    Top = 4
    ...
    object QrRntypPERCENT: TFloatField
      FieldName = 'PERCENT'
    end
  end
