object REPORT_NEPOL: TREPORT_NEPOL
  Left = 101
  Top = 137
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Отчёт о неполученных товарах'
  ClientHeight = 65
  ClientWidth = 470
  Color = clBtnFace
  ...
  object QrNePol: TIBQuery
    Database = DataModule1.IBDatabase1
    Transaction = TrNePol
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select * from report_nepol(:skl_id)'
      'order by tw_art')
    Left = 156
    Top = 8
    ParamData = <
    ...
    object QrNePolDOC_FULL_NUM: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'DOC_FULL_NUM'
      ReadOnly = True
      Size = 74
    end
    object QrNePolDOC_DATE: TDateTimeField
      FieldKind = fkInternalCalc
      FieldName = 'DOC_DATE'
      ReadOnly = True
    end
    object QrNePolTW_ART: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'TW_ART'
      ReadOnly = True
    end
    object QrNePolTW_NAM: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'TW_NAM'
      ReadOnly = True
      Size = 254
    end
    object QrNePolED_SHORT: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'ED_SHORT'
      ReadOnly = True
      Size = 32
    end
    object QrNePolTW_KOL: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'TW_KOL'
      ReadOnly = True
    end
    object QrNePolPOL_KOL: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'POL_KOL'
      ReadOnly = True
    end
    object QrNePolNEPOL_KOL: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'NEPOL_KOL'
      ReadOnly = True
    end
    object QrNePolSKL_FULL: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'SKL_FULL'
      ReadOnly = True
      Size = 254
  ...
  object PpNepol: TppReport
    ...
    object ppTitleBand1: TppTitleBand
      ...
      object ppLabel1: TppLabel
        UserName = 'Label1'
        Caption = 'Отчет о неполученных товарах на склад '
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel27: TppLabel
        UserName = 'Label13'
        Caption = 'Отчет о неполученных товарах на склда :'
        Font.Charset = RUSSIAN_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial Cyr'
        Font.Size = 7
