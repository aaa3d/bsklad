object DIC_RNVID: TDIC_RNVID
  Left = 43
  Top = 148
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Виды расходных накладных'
  ClientHeight = 348
  ClientWidth = 639
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object RichEdit1: TRichEdit
      ...
      Color = 14548223
      Lines.Strings = (
        'Это справочник видов расходных '
        'накладных. '
  ...
  object Query_RNVID: TIBQuery
    Database = DataModule1.IBDatabase1
    Transaction = TransactionVID
    AfterOpen = Query_RNVIDAfterOpen
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select * from RNVID order by RNVID_NAM')
    Left = 64
    Top = 156
    object Query_RNVIDRNVID_ID: TIntegerField
      FieldName = 'RNVID_ID'
      Required = True
    end
    object Query_RNVIDRNVID_NAM: TIBStringField
      FieldName = 'RNVID_NAM'
      Required = True
      Size = 64
    end
