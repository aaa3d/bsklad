inherited Jou_PER: TJou_PER
  ...
  object IBQuery1: TIBQuery
    ...
    Transaction = PerListTranSaction
    BufferChunks = 1000
    CachedUpdates = False
    Left = 24
    Top = 92
  end
  object QrPerList: TIBQuery
    Database = DataModule1.IBDatabase1
    Transaction = PerListTranSaction
    AfterOpen = QrPerListAfterOpen
    AfterScroll = QrPerListAfterScroll
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      
        'select * from list_per(:DT1,:DT2,:SKL_FROM_ID,:SKL_TO_ID, :FRM_I' +
        'D)')
    Left = 188
    Top = 97
    ParamData = <
    ...
    object QrPerListPER_ID: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'PER_ID'
      ReadOnly = True
    end
    object QrPerListPER_NUM_FULL: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'PER_NUM_FULL'
      ReadOnly = True
      Size = 74
    end
    object QrPerListPER_DATE: TDateTimeField
      FieldKind = fkInternalCalc
      FieldName = 'PER_DATE'
      ReadOnly = True
    end
    object QrPerListSKL_FROM: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'SKL_FROM'
      ReadOnly = True
      Size = 64
    end
    object QrPerListSKL_TO: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'SKL_TO'
      ReadOnly = True
      Size = 64
    end
    object QrPerListPER_SUMM: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'PER_SUMM'
      ReadOnly = True
      DisplayFormat = ',#0.00 руб'
    end
    object QrPerListPER_OTG: TSmallintField
      FieldKind = fkInternalCalc
      FieldName = 'PER_OTG'
      ReadOnly = True
    end
    object QrPerListPER_POL: TSmallintField
      FieldKind = fkInternalCalc
      FieldName = 'PER_POL'
      ReadOnly = True
    end
    object QrPerListPER_COLOR: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'PER_COLOR'
      ReadOnly = True
    end
    object QrPerListUS_FULL: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'US_FULL'
      ReadOnly = True
      Size = 128
    end
    object QrPerListPER_PROW: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'PER_PROW'
      ReadOnly = True
      Size = 1
    end
    object QrPerListPER_OSN: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'PER_OSN'
      ReadOnly = True
      Size = 254
    end
    object QrPerListPER_NUM: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'PER_NUM'
      ReadOnly = True
    end
    object QrPerListPER_WEIGHT: TFloatField
      FieldName = 'PER_WEIGHT'
      Origin = 'LIST_PER.PER_WEIGHT'
      DisplayFormat = '#0.00 кг'
    end
    object QrPerListMH_FORM_TYPE: TIntegerField
      FieldName = 'MH_FORM_TYPE'
      Origin = 'LIST_PER.MH_FORM_TYPE'
    end
  end
  object DsPerList: TDataSource
    DataSet = QrPerList
    Left = 188
    Top = 153
  end
  object PerListTranSaction: TIBTransaction
    Active = True
  ...
  object PipPerList: TppDBPipeline
    DataSource = DsPerList
    UserName = 'PipPerList'
    Left = 188
    Top = 213
    object PipPerListppField1: TppField
      FieldAlias = 'PER_ID'
      FieldName = 'PER_ID'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipPerListppField2: TppField
      FieldAlias = 'PER_NUM_FULL'
      FieldName = 'PER_NUM_FULL'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
    ...
    object PipPerListppField3: TppField
      FieldAlias = 'PER_DATE'
      FieldName = 'PER_DATE'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipPerListppField4: TppField
      FieldAlias = 'SKL_FROM'
      FieldName = 'SKL_FROM'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipPerListppField5: TppField
      FieldAlias = 'SKL_TO'
      FieldName = 'SKL_TO'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipPerListppField6: TppField
      FieldAlias = 'PER_SUMM'
      FieldName = 'PER_SUMM'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipPerListppField7: TppField
      FieldAlias = 'PER_OTG'
      FieldName = 'PER_OTG'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipPerListppField8: TppField
      FieldAlias = 'PER_POL'
      FieldName = 'PER_POL'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipPerListppField9: TppField
      FieldAlias = 'PER_COLOR'
      FieldName = 'PER_COLOR'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
    ...
    object PipPerListppField10: TppField
      FieldAlias = 'US_FULL'
      FieldName = 'US_FULL'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipPerListppField11: TppField
      FieldAlias = 'PER_PROW'
      FieldName = 'PER_PROW'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipPerListppField12: TppField
      FieldAlias = 'PER_OSN'
      FieldName = 'PER_OSN'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipPerListppField13: TppField
      FieldAlias = 'PER_NUM'
      FieldName = 'PER_NUM'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipPerListppField14: TppField
      FieldAlias = 'PER_WEIGHT'
      FieldName = 'PER_WEIGHT'
      FieldLength = 10
      DataType = dtNotKnown
      DisplayWidth = 10
  ...
  object PpPERLIST: TppReport
    AutoStop = False
    DataPipeline = PipPerList
    ...
    CachePages = True
    DeviceType = 'Screen'
    OnPreviewFormCreate = PpPERLISTPreviewFormCreate
    Left = 188
    Top = 266
    Version = '5.0'
    mmColumnWidth = 0
    object ppTitleBand12: TppTitleBand
      ...
      object ppRegion66: TppRegion
        ...
        object ppLabel1: TppLabel
          UserName = 'Label6'
          Caption = 'Журнал накладных перемещения за период с '
    ...
    object ppSummaryBand12: TppSummaryBand
      ...
      object ppLabel464: TppLabel
        UserName = 'Label9'
        Caption = 'накладных перемещения на сумму'
        Font.Charset = RUSSIAN_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial Cyr'
        Font.Size = 8
