...
uses 
  Windows, Registry, Messages, Classes, Controls, Forms, Grids, Graphics, Buttons, Menus,
...
procedure TRxDBGrid.WMVScroll(var Message: TWMVScroll);
//Iiai?aaeaiiay ia?aaioea WM_VSCROLL ec iiaoey DBGrids Delphi:
// - Ii SB_LINEUP, SB_LINEDOWN ia?aiauaainy ia iaio no?ieo aaa?o/aiec,
//  a ia nea?ai a ia?aei/eiiao Grid'a
// - "Ieaaiay" i?ie?ooea: Grid i?ie?o?eaaaony i?e ia?aiauaiee aaaoiea,
//  a ia oieuei iinea oiai, eae ioionoei eiiieo iuoe
var SI: TScrollInfo;
begin
