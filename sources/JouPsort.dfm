inherited Jou_PSORT: TJou_PSORT
  Left = 264
  Top = 245
  Caption = 'Журнал Актов пересортицы'
  ClientWidth = 756
  OldCreateOrder = True
    ...
    inherited RxDBGrid1: TRxDBGrid
      ...
      Columns = <
        ...
        item
          ...
          PickList.Strings = ()
          Title.Alignment = taCenter
          Title.Caption = 'Менеджер-владелец полученного товара'
          Width = 230
          Visible = True
        end
        item
  ...
  object IBQuery1: TIBQuery
    ...
    Transaction = PsortListTransaction
    BufferChunks = 1000
    CachedUpdates = False
    Left = 24
    Top = 92
  end
  object DsPsortList: TDataSource
    DataSet = QrPsortList
    Left = 96
    Top = 145
  end
  object PsortListTransaction: TIBTransaction
    Active = False
  ...
  object QrPsortList: TIBQuery
    Database = DataModule1.IBDatabase1
    Transaction = PsortListTransaction
    AfterOpen = QrPsortListAfterOpen
    AfterScroll = QrPsortListAfterScroll
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select * from list_psort(:DT1,:DT2,:frm_id) '
      'order by psort_date')
    Left = 96
    Top = 97
    ParamData = <
    ...
    object QrPsortListPSORT_ID: TIntegerField
      FieldName = 'PSORT_ID'
      Origin = 'LIST_PSORT.PSORT_ID'
    end
    object QrPsortListPSORT_COLOR: TIntegerField
      FieldName = 'PSORT_COLOR'
      Origin = 'LIST_PSORT.PSORT_COLOR'
    end
    object QrPsortListPSORT_FULL_NUM: TIBStringField
      FieldName = 'PSORT_FULL_NUM'
      Origin = 'LIST_PSORT.PSORT_FULL_NUM'
      Size = 64
    end
    object QrPsortListPSORT_DATE: TDateTimeField
      FieldName = 'PSORT_DATE'
      Origin = 'LIST_PSORT.PSORT_DATE'
    end
    object QrPsortListSKL_NAME: TIBStringField
      FieldName = 'SKL_NAME'
      Origin = 'LIST_PSORT.SKL_NAME'
      Size = 128
    end
    object QrPsortListPSORT_OSN: TIBStringField
      FieldName = 'PSORT_OSN'
      Origin = 'LIST_PSORT.PSORT_OSN'
      Size = 254
    end
    object QrPsortListUS_FULL: TIBStringField
      FieldName = 'US_FULL'
      Origin = 'LIST_PSORT.US_FULL'
      Size = 128
    end
    object QrPsortListPSORT_PROW: TIBStringField
      FieldName = 'PSORT_PROW'
      Origin = 'LIST_PSORT.PSORT_PROW'
      FixedChar = True
      Size = 1
    end
    object QrPsortListPSORT_MEN: TIBStringField
      FieldName = 'PSORT_MEN'
      Origin = 'LIST_PSORT.PSORT_MEN'
      Size = 64
    end
  end
  ...
  object PipPsortList: TppDBPipeline
    DataSource = DsPsortList
    UserName = 'PipPsortList'
    Left = 96
    Top = 197
    object PipPsortListppField1: TppField
    ...
    object PipPsortListppField2: TppField
      Alignment = taRightJustify
      FieldAlias = 'PSORT_COLOR'
      FieldName = 'PSORT_COLOR'
      FieldLength = 0
      DataType = dtInteger
      DisplayWidth = 10
    ...
    object PipPsortListppField3: TppField
      FieldAlias = 'PSORT_FULL_NUM'
      FieldName = 'PSORT_FULL_NUM'
      FieldLength = 64
      DisplayWidth = 64
      Position = 2
    end
    object PipPsortListppField4: TppField
      FieldAlias = 'PSORT_DATE'
      FieldName = 'PSORT_DATE'
      FieldLength = 0
      DataType = dtDateTime
      DisplayWidth = 18
    ...
    object PipPsortListppField5: TppField
      FieldAlias = 'SKL_NAME'
      FieldName = 'SKL_NAME'
      FieldLength = 128
      DisplayWidth = 128
    ...
    object PipPsortListppField6: TppField
      FieldAlias = 'PSORT_OSN'
      FieldName = 'PSORT_OSN'
      FieldLength = 254
      DisplayWidth = 254
      Position = 5
    end
    object PipPsortListppField7: TppField
      FieldAlias = 'US_FULL'
      FieldName = 'US_FULL'
      FieldLength = 128
      DisplayWidth = 128
    ...
    object PipPsortListppField8: TppField
      FieldAlias = 'PSORT_PROW'
      FieldName = 'PSORT_PROW'
      FieldLength = 1
      DisplayWidth = 1
      Position = 7
  ...
  object PpPsortLIST: TppReport
    AutoStop = False
    DataPipeline = PipPsortList
    ...
    CachePages = True
    DeviceType = 'Screen'
    OnPreviewFormCreate = PpPsortLISTPreviewFormCreate
    Left = 96
    Top = 250
    Version = '5.0'
    mmColumnWidth = 0
    object ppTitleBand12: TppTitleBand
      ...
      object ppRegion66: TppRegion
        ...
        object ppLabel1: TppLabel
          UserName = 'Label6'
          Caption = 'Журнал актов пересортицы за период с '
        ...
        object PsortListTitle1: TppLabel
          UserName = 'Label10'
          Caption = 'Label10'
          Font.Charset = RUSSIAN_CHARSET
          Font.Color = clWhite
    ...
    object ppFooterBand14: TppFooterBand
      ...
      object PpPsortListUser: TppLabel
        UserName = 'PpRnUser'
      ...
      object PsortListTitle2: TppLabel
        UserName = 'PpRnTitle'
      ...
      object PpPsortListVers: TppLabel
        UserName = 'Label20'
