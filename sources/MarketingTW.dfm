object Marketing_TW: TMarketing_TW
  Left = 12
  Top = 90
      ...
      object RxDBGrid1: TRxDBGrid
        ...
        Columns = <
          ...
          item
            ...
            FieldName = 'US_FULL'
            Title.Alignment = taCenter
            Title.Caption = 'Кто предоставил информацию'
            Width = 167
            Visible = True
          end
          item
  ...
  object ToolBar1: TToolBar
    ...
    object BtnNEw: TToolButton
      Left = 33
      Top = 2
      Hint = 'Новые маркетинговые сведения (INS)'
      Caption = 'BtnNEw'
      ImageIndex = 0
      OnClick = BtnNEwClick
    end
    object BtnOPEN: TToolButton
      Left = 58
      Top = 2
      Hint = 'Править маркетинговые сведения (Enter)'
      Caption = 'BtnOPEN'
      ImageIndex = 1
    ...
    object BtnDEL: TToolButton
      Left = 83
      Top = 2
      Hint = 'Удалить маркетинговые сведения (DEL)'
      Caption = 'BtnDEL'
      ImageIndex = 2
      OnClick = BtnDELClick
    end
    object BtnPrint: TToolButton
      Left = 108
      Top = 2
      Hint = 'Печать выбранного отображения (F9)'
      Caption = 'BtnPrint'
      ImageIndex = 9
    ...
    object Arc: TCheckBox
      ...
      Width = 185
      Height = 24
      Caption = 'Показывать архивные данные'
      TabOrder = 0
      OnClick = ArcClick
    end
  end
  object MarketingTransaction: TIBTransaction
    Active = True
  ...
  object QueryPost: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select MARKET.MARKET_ID, MARKET.TW_MONEY, MARKET.TW_MONEYD, MARK' +
        'ET.KLN_FULL, MARKET.MARKET_DATE, MARKET.MARKET_PRIM,'
      'BG_LEFT(KLN.KLN_FAM||" "||BG_LEFT(KLN.KLN_NAME,1)||". "||'
      'BG_LEFT(KLN.KLN_NAME2,1)||".",254) as US_FULL'
      'FROM MARKET,KLN'
      'WHERE MARKET.TW_ID=:TW_ID'
      'and MARKET.MARKET_TYP=1'
      'and MARKET.US_ID=KLN.KLN_ID'
      'and MARKET.MARKET_DATE>:MARKET_DATE'
    ...
    object QueryPostMARKET_ID: TIntegerField
      FieldName = 'MARKET_ID'
      Required = True
    end
    object QueryPostTW_MONEY: TFloatField
      FieldName = 'TW_MONEY'
      DisplayFormat = ',#0.00 руб'
    end
    object QueryPostTW_MONEYD: TFloatField
      FieldName = 'TW_MONEYD'
      DisplayFormat = ',#0.00 $'
    end
    object QueryPostKLN_FULL: TIBStringField
      FieldName = 'KLN_FULL'
      Size = 254
    end
    object QueryPostMARKET_DATE: TDateTimeField
      FieldName = 'MARKET_DATE'
      Required = True
    end
    object QueryPostMARKET_PRIM: TIBStringField
      FieldName = 'MARKET_PRIM'
      Size = 254
    end
    object QueryPostUS_FULL: TIBStringField
      FieldName = 'US_FULL'
      Required = True
      FixedChar = True
      Size = 1024
  ...
  object QueryKonk: TIBQuery
    ...
    object QueryKonkUS_FULL: TIBStringField
      FieldName = 'US_FULL'
      Required = True
      FixedChar = True
      Size = 1024
  ...
  object PipKonk: TppDBPipeline
    DataSource = DsKonk
    UserName = 'PipKonk'
    Left = 276
    Top = 273
    object PipKonkppField1: TppField
      FieldAlias = 'MARKET_ID'
      FieldName = 'MARKET_ID'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
    ...
    object PipKonkppField2: TppField
      FieldAlias = 'TW_MONEY'
      FieldName = 'TW_MONEY'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipKonkppField3: TppField
    ...
    object PipKonkppField4: TppField
      FieldAlias = 'KLN_FULL'
      FieldName = 'KLN_FULL'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipKonkppField5: TppField
      FieldAlias = 'MARKET_DATE'
      FieldName = 'MARKET_DATE'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
    ...
    object PipKonkppField6: TppField
      FieldAlias = 'MARKET_PRIM'
      FieldName = 'MARKET_PRIM'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
    ...
    object PipKonkppField7: TppField
      FieldAlias = 'US_FULL'
      FieldName = 'US_FULL'
      FieldLength = 0
      DataType = dtNotKnown
  ...
  object PpKonk: TppReport
    AutoStop = False
    DataPipeline = PipKonk
    PassSetting = psTwoPass
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Марктинговые данные товара. Конкуренты'
    ...
    UserName = 'Report'
    DeviceType = 'Screen'
    OnPreviewFormCreate = PpKonkPreviewFormCreate
    Left = 276
    Top = 333
    Version = '5.0'
    mmColumnWidth = 0
    object ppTitleBand1: TppTitleBand
      ...
      object PpKonk_Title1: TppMemo
        UserName = 'PpKonk_Title1'
        Caption = 'PpKonk_Title1'
        CharWrap = False
        Font.Charset = RUSSIAN_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial Cyr'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object PpKonkUser2: TppLabel
        UserName = 'PpKonkUser2'
        Caption = 'PpRnUser'
        Font.Charset = RUSSIAN_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial Cyr'
      ...
      object PpKonk_Title2: TppMemo
        UserName = 'PpKonk_Title2'
        Caption = 'PpKonk_Title1'
        CharWrap = False
        Font.Charset = RUSSIAN_CHARSET
        Font.Color = clBlack
  ...
  object PpPost: TppReport
    ...
    PassSetting = psTwoPass
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Марктинговые данные товара. Поставщики товара'
    PrinterSetup.PaperName = 'Letter'
    PrinterSetup.PrinterName = 'Default'
    PrinterSetup.mmMarginBottom = 6350
    PrinterSetup.mmMarginLeft = 6350
