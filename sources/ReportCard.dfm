object Report_card: TReport_card
  Left = 76
  Top = 193
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Отчёт об использовании пластиковых дисконтных карт'
  ClientHeight = 92
  ClientWidth = 463
  Color = clBtnFace
  ...
  object Label3: TLabel
    ...
    Width = 204
    Height = 13
    Caption = 'Результирующий отчёт упорядочить по :'
  end
  ...
  object SORT: TComboBox
    ...
    Text = 'SORT'
    Items.Strings = (
      'сумме первой покупки'
      'сумме покупок за указанный период'
      'количестве накладных за указанный период'
      'сумме предоставленных скидок'
      'сумме всех покупок'
      'текущему проценту скидки'
      'номеру карты'
      'дате выдачи карты')
  end
  ...
  object PipCard: TppDBPipeline
    DataSource = DataModule2.DsCard
    UserName = 'PipCard'
    Left = 36
    Top = 48
    object PipCardppField1: TppField
    ...
    object PipCardppField2: TppField
      Alignment = taRightJustify
      FieldAlias = 'CARD_NUM'
      FieldName = 'CARD_NUM'
      FieldLength = 0
    ...
    object PipCardppField3: TppField
      FieldAlias = 'CARD_DATE'
      FieldName = 'CARD_DATE'
      FieldLength = 0
      DataType = dtDateTime
      DisplayWidth = 18
    ...
    object PipCardppField4: TppField
      FieldAlias = 'CARD_OSN'
      FieldName = 'CARD_OSN'
      FieldLength = 254
      DisplayWidth = 254
    ...
    object PipCardppField5: TppField
      Alignment = taRightJustify
      FieldAlias = 'FIRST_SUMM'
    ...
    object PipCardppField6: TppField
      Alignment = taRightJustify
      FieldAlias = 'PERIOD_SUMM'
    ...
    object PipCardppField7: TppField
      Alignment = taRightJustify
      FieldAlias = 'PERIOD_COUNT'
    ...
    object PipCardppField8: TppField
      Alignment = taRightJustify
      FieldAlias = 'PERIOD_SKID'
    ...
    object PipCardppField9: TppField
      Alignment = taRightJustify
      FieldAlias = 'CURRENT_SUMM'
    ...
    object PipCardppField10: TppField
      Alignment = taRightJustify
      FieldAlias = 'CURRENT_SKID'
    ...
    object PipCardppField11: TppField
      FieldAlias = 'KLN_FULL'
      FieldName = 'KLN_FULL'
      FieldLength = 254
      DisplayWidth = 254
  ...
  object PpCard: TppReport
    AutoStop = False
    DataPipeline = PipCard
    PassSetting = psTwoPass
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Отчет об использовании пластиковых карт'
    ...
    UserName = 'Report'
    DeviceType = 'Screen'
    OnPreviewFormCreate = PpCardPreviewFormCreate
    Left = 92
    Top = 44
    Version = '5.0'
    mmColumnWidth = 0
    object ppTitleBand1: TppTitleBand
      ...
      object PpCard_Title1: TppMemo
        UserName = 'PpCard_Title1'
        Caption = 'PpCard_Title1'
        CharWrap = False
        Font.Charset = RUSSIAN_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial Cyr'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object PpCardUser2: TppLabel
        UserName = 'PpCardUser2'
        Caption = 'PpCardUser'
        Font.Charset = RUSSIAN_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial Cyr'
      ...
      object PpCard_Title2: TppMemo
        UserName = 'PpCard_Title2'
        Caption = 'PpCard_Title1'
        CharWrap = False
        Font.Charset = RUSSIAN_CHARSET
        Font.Color = clBlack
