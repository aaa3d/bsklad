object REPORT_MARKETOLD: TREPORT_MARKETOLD
  Left = 39
  Top = 141
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Отчёт об устаревших маркетинговых данных товаров у конкурентов'
  ClientHeight = 137
  ClientWidth = 499
  Color = clBtnFace
  ...
  object Label2: TLabel
    ...
    Height = 13
    Caption = 
      'Выводить товары у которых срок маркетинговых данных закончится ч' +
      'ерез'
  end
  ...
  object ARC: TCheckBox
    ...
    Width = 389
    Height = 17
    Caption = 'Выводить только товары, по которым были маркетинговые данные'
    TabOrder = 3
  end
  object DAY: TRxSpinEdit
    Left = 396
    Top = 80
    Width = 61
    Height = 21
  ...
  object PipOld: TppDBPipeline
    DataSource = DataModule2.DsOld
    UserName = 'PipOld'
    Left = 212
    Top = 4
    object PipOldppField1: TppField
    ...
    object PipOldppField2: TppField
      FieldAlias = 'TW_NAM'
      FieldName = 'TW_NAM'
      FieldLength = 254
      DisplayWidth = 254
    ...
    object PipOldppField3: TppField
      FieldAlias = 'ED_SHORT'
      FieldName = 'ED_SHORT'
      FieldLength = 32
      DisplayWidth = 32
    ...
    object PipOldppField4: TppField
    ...
    object PipOldppField5: TppField
      Alignment = taRightJustify
      FieldAlias = 'TW_MONEY'
      FieldName = 'TW_MONEY'
      FieldLength = 0
    ...
    object PipOldppField6: TppField
      Alignment = taRightJustify
    ...
    object PipOldppField7: TppField
  ...
  object PpOld: TppReport
    AutoStop = False
    DataPipeline = PipOld
    PassSetting = psTwoPass
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Отчет о товарах, имеющих утсаревшие маркетинговые данные'
    ...
    UserName = 'Report'
    DeviceType = 'Screen'
    OnPreviewFormCreate = PpOldPreviewFormCreate
    Left = 268
    Top = 4
    Version = '5.0'
    mmColumnWidth = 0
    object ppTitleBand1: TppTitleBand
      ...
      object ppLabel8: TppLabel
        UserName = 'Label8'
        Caption = 'Последняя информация  Место для примечаний'
        Font.Charset = RUSSIAN_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 7
