object MAKE_TW_REAL_TO_KLN: TMAKE_TW_REAL_TO_KLN
  Left = 274
  Top = 203
  Width = 472
  Height = 385
  Caption = 'Оформить продажу остатков внутреннему клиенту'
  Color = clBtnFace
  ...
  object Label4: TLabel
    ...
    Width = 309
    Height = 13
    Caption = 'Создает документы в журнале РН: БНАЛИП и ПН: БНАЛИП.'
  end
