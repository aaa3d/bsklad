...
procedure TEdit_RnVid.FormKeyPress(Sender: TObject; var Key: Char);
begin
...
procedure TEdit_RnVid.BtnSaveClick(Sender: TObject);
begin
     SAVE:=False;
     BtnApply.click;
     if Save then close;
...
procedure TEdit_RnVid.BtnCloseClick(Sender: TObject);
begin
     close;
end;

procedure TEdit_RnVid.FormCloseQuery(Sender: TObject;
...
procedure TEdit_RnVid.FormClose(Sender: TObject; var Action: TCloseAction);
begin
     QueryRnVid.close;
     RnVidTransaction.Active:=False;
end;

procedure TEdit_RnVid.FormShow(Sender: TObject);
begin
...
procedure TEdit_RnVid.BtnApplyClick(Sender: TObject);
var
   r:double;
begin
...
procedure TEdit_RnVid.RNVID_NAMChange(Sender: TObject);
begin
     Save:=False;
end;
