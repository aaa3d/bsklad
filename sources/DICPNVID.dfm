object DIC_PNVID: TDIC_PNVID
  Left = 3
  Top = 108
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Виды приходных накладных'
  ClientHeight = 348
  ClientWidth = 632
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object RichEdit1: TRichEdit
      ...
      Color = 14548223
      Lines.Strings = (
        'Это справочник видов приходных '
        'накладных. '
  ...
  object Query_PNVID: TIBQuery
    Database = DataModule1.IBDatabase1
    Transaction = TransactionVID
    AfterOpen = Query_PNVIDAfterOpen
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
    ...
    Left = 64
    Top = 156
    object Query_PNVIDPNVID_ID: TIntegerField
      FieldName = 'PNVID_ID'
      Required = True
    end
    object Query_PNVIDPNVID_NAM: TIBStringField
      FieldName = 'PNVID_NAM'
      Required = True
      Size = 64
    end
    object Query_PNVIDPNVID_ACTIV: TIntegerField
