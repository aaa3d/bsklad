inherited Jou_ST: TJou_ST
  ...
  object QrStList: TIBQuery
    Database = DataModule1.IBDatabase1
    Transaction = StListTranSaction
    AfterOpen = QrStListAfterOpen
    AfterScroll = QrStListAfterScroll
    BufferChunks = 1000
    CachedUpdates = False
    SQL.Strings = (
      'select * from list_st(:DT1,:DT2,:frm_id)')
    Left = 96
    Top = 149
    ParamData = <
      item
    ...
    object QrStListST_SUMM: TFloatField
      FieldKind = fkInternalCalc
      FieldName = 'ST_SUMM'
      ReadOnly = True
      DisplayFormat = '#0.00'
    end
    object QrStListST_ID: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'ST_ID'
      ReadOnly = True
    end
    object QrStListST_NUM_FULL: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'ST_NUM_FULL'
      ReadOnly = True
      Size = 74
    end
    object QrStListST_DATE: TDateTimeField
      FieldKind = fkInternalCalc
      FieldName = 'ST_DATE'
      ReadOnly = True
    end
    object QrStListST_COLOR: TIntegerField
      FieldKind = fkInternalCalc
      FieldName = 'ST_COLOR'
      ReadOnly = True
    end
    object QrStListUS_FULL: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'US_FULL'
      ReadOnly = True
      Size = 128
    end
    object QrStListKLN_ORG: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'KLN_ORG'
      ReadOnly = True
      Size = 254
    end
    object QrStListKLN_PREFIX: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'KLN_PREFIX'
      ReadOnly = True
      Size = 32
    end
    object QrStListVALUTA_SHORT: TIBStringField
      FieldKind = fkInternalCalc
      FieldName = 'VALUTA_SHORT'
      ReadOnly = True
      Size = 32
  ...
  object DsStList: TDataSource
    DataSet = QrStList
    Left = 96
    Top = 201
  end
  object StListTranSaction: TIBTransaction
    Active = False
  ...
  object PopupMenu1: TPopupMenu
    ...
    object MnSubDoc: TMenuItem
      Caption = 'Создать новый документ на основании счёта...'
      OnClick = BtnSubDocClick
    end
    ...
    object MnAdm: TMenuItem
      Caption = 'Администрирование счета'
      ImageIndex = 25
      ShortCut = 16449
      OnClick = BtnAdmClick
    end
  end
  object PipStList: TppDBPipeline
    DataSource = DsStList
    UserName = 'PipStList'
    Left = 160
    Top = 249
    object PipStListppField1: TppField
      FieldAlias = 'ST_SUMM'
      FieldName = 'ST_SUMM'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipStListppField2: TppField
      FieldAlias = 'ST_ID'
      FieldName = 'ST_ID'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipStListppField3: TppField
    ...
    object PipStListppField4: TppField
      FieldAlias = 'ST_DATE'
      FieldName = 'ST_DATE'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipStListppField5: TppField
      FieldAlias = 'ST_COLOR'
      FieldName = 'ST_COLOR'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipStListppField6: TppField
      FieldAlias = 'US_FULL'
      FieldName = 'US_FULL'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipStListppField7: TppField
      FieldAlias = 'KLN_ORG'
      FieldName = 'KLN_ORG'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object PipStListppField8: TppField
    ...
    object PipStListppField9: TppField
  ...
  object PpSTLIST: TppReport
    AutoStop = False
    DataPipeline = PipStList
    ...
    CachePages = True
    DeviceType = 'Screen'
    OnPreviewFormCreate = PpSTLISTPreviewFormCreate
    Left = 96
    Top = 250
    Version = '5.0'
    mmColumnWidth = 0
    ...
    object ppFooterBand14: TppFooterBand
      ...
      object StListTitle2: TppLabel
        UserName = 'PpRnTitle'
        Caption = 'StListTitle2'
        Font.Charset = RUSSIAN_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial Cyr'
        Font.Size = 8
