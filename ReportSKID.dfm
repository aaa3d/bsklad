object REPORT_SKID: TREPORT_SKID
  ...
  Caption = 'Отчёт о скидках, обоснованных пользователями'
  ClientHeight = 224
  ClientWidth = 502
  Color = clBtnFace
  ...
  object Label3: TLabel
    ...
    Width = 196
    Height = 13
    Caption = 'Предоставленная скидка превышает :'
  end
  ...
  object GroupBox1: TGroupBox
    ...
    Width = 489
    Height = 69
    Caption = ' Тип расходных накладных '
    TabOrder = 2
  ...
  object GroupBox2: TGroupBox
    ...
    Width = 489
    Height = 73
    Caption = ' Обоснованных пользователями '
    TabOrder = 3
    ...
    object BtnKLN: TBitBtn
      ...
      Width = 23
      Height = 21
      Hint = 'Выбрать пользователя из списка контактов (F10)'
      TabOrder = 3
      OnClick = BtnKLNClick
      Glyph.Data = {
  ...
  object PopupMenu1: TPopupMenu
    ...
    object MnKLN: TMenuItem
      Caption = 'Выбрать пользователя из справочника контактов'
      ShortCut = 121
      OnClick = BtnKLNClick
    end
  end
  ...
  object PpSkid: TppReport
    ...
    PrinterSetup.DocumentName = 'Отчет об обоснованных скидках'
    ...
    object ppSummaryBand1: TppSummaryBand
      ...
      object ppLabel49: TppLabel
        UserName = 'Label12'
        Alignment = taRightJustify
        Caption = 'Итого сумма скидок составила :'
        Font.Charset = RUSSIAN_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 7
