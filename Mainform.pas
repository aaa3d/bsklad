...
type
  TMAIN_FORM = class(TForm)
    ...
    procedure mnuCardSkidCouponClick(Sender: TObject);
  private
...
uses DicValuta, UsWorkForm, DicTowar, KursMoney, DicKlient, DicSklad,
  ...
  EditTwSkladParams, CardSkidCoupon;
...
procedure TMAIN_FORM.mnuCardSkidCouponClick(Sender: TObject);
begin
    application.createform(TCARD_SKID_COUPON,CARD_SKID_COUPON);
   CARD_SKID_COUPON.showModal;
   CARD_SKID_COUPON.Destroy;
end;
