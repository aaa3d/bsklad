...
;General
  ...
  ;Name and file
  Caption "Universal Viewer ${Free} ${Ver} - Setup"
  Name    "Universal Viewer"
  OutFile "UniversalViewer${Free}Setup.exe"
...
Section "Uninstall"
  ...
  ;Commented to not delete RegInfo:
  ;DeleteRegKey /ifempty HKCU "Software\UniversalViewer"
