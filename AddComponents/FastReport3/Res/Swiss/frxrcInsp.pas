...
begin
  ...
  begin
    ...
    Add('propAutoSize', 'Legt fest, ob das Bild seine Grösse automatisch berechnet');
    ...
    Add('propBevelOuter', 'Der Typ des äusseren Rahmens');
    Add('propBevelWidth', 'Die Breite des Rahmens');
    Add('propBorder', 'Legt fest, ob der äussere Rahmen angezeigt wird');
    Add('propBorderStyle', 'Der Stil des Fensters');
    Add('propBottomMargin', 'Die Grösse des unteren Seitenrandes');
    ...
    Add('propFiltered', 'Legt fest, ob das Dataset die Sätze gemäss Filterbedingung filtert');
    ...
    Add('propLargeDesignHeight', 'Legt fest, ob die Seite im Entwurfsmodus vergössert wird');
    Add('propLayout', 'Anordnung des Bildes auf der Schaltfläche');
    Add('propLeft', 'Die linke Koordinate des Objekts');
    Add('propLeftMargin', 'Die Grösse des linken Seitenrandes');
    ...
    Add('propModalResult', 'Legt fest, ob und wie die Schaltfläche das modale Formular schliesst');
    ...
    Add('propRightMargin', 'Die Grösse des rechten Randes');
    ...
    Add('propSize', 'Die Grösse der Schrift');
    ...
    Add('propStretch', 'Dehnt das Bild bis zur Objektgrösse');
    ...
    Add('propTopMargin', 'Die Grösse des oberen Seitenrandes');
