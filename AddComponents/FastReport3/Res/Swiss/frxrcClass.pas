...
begin
  ...
  begin
    Add('TfrxPreviewForm',
      ...
      'CancelB.Caption=Schliessen' + #13#10 +
    ...
    Add('TfrxSearchDialog',
      ...
      'CaseCB.Caption=Gross/Klein' + #13#10 +
      'OkB.Caption=OK' + #13#10 +
      'CancelB.Caption=Abbruch' + #13#10 +
      '');
