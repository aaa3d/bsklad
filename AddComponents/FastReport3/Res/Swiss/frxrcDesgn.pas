...
begin
  ...
  begin
    ...
    Add('TfrxDesignerForm',
      ...
      'SpaceVertB.Hint=Abstand vertical' + #13#10 +
      'CenterHorzB.Hint=Horizontal im Band zentrieren' + #13#10 +
      'CenterVertB.Hint=Vertical im Band zentrieren' + #13#10 +
      ...
      'FontSizeCB.Hint=Schriftgrösse' + #13#10 +
      ...
      'PageFooterMI.Caption=Seitenfuss' + #13#10 +
      'HeaderMI.Caption=Kopf' + #13#10 +
      'FooterMI.Caption=Fuss' + #13#10 +
      ...
      'GroupFooterMI1.Caption=Gruppenfuss' + #13#10 +
    ...
    Add('TfrxPageEditorForm',
      ...
      'LargeHeightCB.Caption=Seitenhöhe im Entwurfsmodus vergrössern' + #13#10 +
      '');
    ...
    Add('TfrxOptionsEditor',
      ...
      'Label9.Caption=Grösse' + #13#10 +
      'Label10.Caption=Grösse' + #13#10 +
    ...
    Add('TfrxOleEditorForm',
      ...
      'EditB.Caption=Bearbeiten...' + #13#10 +
      'CloseB.Caption=Schliessen' + #13#10 +
      '');
    ...
    Add('pvAutoSize', 'Grösse automatisch');
    ...
    Add('bvKeepFooter', 'Fuss zusammenhalten');
    ...
    Add('bvFooterAfterEach', 'Fuss nach jeder Zeile');
    Add('srParent', 'Druck auf Parent');
    Add('bvKeepHeader', 'Header zusammenhalten');
    ...
    Add('FloatToStr', 'Konvertiert einen Fliesskommawert in eine Zeichenkette');
    ...
    Add('StrToFloat', 'Konvertiert eine Zeichenkette in einen Fliesskommawert');
    ...
    Add('FormatFloat', 'Formatiert einen Fliesskommawert');
    Add('FormatDateTime', 'Formatiert einen Datums-und-Zeitwert');
    Add('FormatMaskText', 'Liefert eine gemäss edit-mask formatierte Zeichenkette');
    ...
    Add('Uppercase', 'Konvertiert alle Zeichen einer Zeichenkette in Grossbuchstaben');
    ...
    Add('NameCase', 'Konvertiert den ersten Buchstaben eines Wortes in Grossbuchstaben');
    ...
    Add('Round', 'Rundet einen Fliesskommawert zum nächsten Ganzzahlwert');
    Add('Trunc', 'Schneidet Nachkommastellen eines Fliesskommawerts ab');
    Add('Int', 'Liefert den Ganzzahlanteil eines Fliesskommawerts');
    Add('Frac', 'Liefert den Nachkommaanteil eines Fliesskommawerts');
    ...
    Add('Ln', 'Liefert den natürlichen Logarithmus eines Fliesskommaausdrucks');
    ...
    Add('ValidFloat', 'Liefert True wenn die angegenbene Zeichenkette einen gültigen Fliesskommawert enthält');
