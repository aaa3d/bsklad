...
initialization
  ...
  frxPropertyEditors.Register(TypeInfo(TStrings), TfrxMemoView, 'Memo', TfrxMemoProperty);
  ...
  frxHideProperties(TfrxReport, 'IniFile;Name;Preview;ScriptLanguage;ScriptText;Tag;Variables;DataSetName;DotMatrixReport;OldStyleProgress;StoreInDFM');
  frxHideProperties(TfrxEngineOptions, 'MaxMemSize;PrintIfEmpty;SilentMode;TempDir;UseFileCache');
