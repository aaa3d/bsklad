...
initialization
  frxObjects.RegisterCategory('DBX', nil, 'obDBXComps', 51);
  frxObjects.RegisterObject1(TfrxDBXDataBase, nil, '', 'DBX', 0, 37);
  frxObjects.RegisterObject1(TfrxDBXTable, nil, '', 'DBX', 0, 38);
  frxObjects.RegisterObject1(TfrxDBXQuery, nil, '', 'DBX', 0, 39);
