...
uses
  ...
  Dialogs, ExtCtrls, StdCtrls, Buttons, frxClass
{$IFDEF Delphi6}
, Variants
{$ENDIF};
...
type
  TfrxDesignMode = (dmSelect, dmInsert);
  TfrxDesignMode1 = (dmNone, dmMove, dmSize, dmSizeBand, dmScale,
    dmInplaceEdit, dmSelectionRect, dmInsertObject, dmInsertLine, dmMoveGuide);
  TfrxGridType = (gt1pt, gt1cm, gt1in, gtDialog, gtChar);
...
uses frxDMPClass, frxUtils, frxGraphicUtils, frxCtrls;
...
begin
  ...
  FBMPBand:= TBitmap.Create;
  FBMPBand.LoadFromResourceName(hInstance, 'frxBAND');
