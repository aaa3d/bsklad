...
var
  ...
  begin
    ...
    begin
      ...
      Brush.Style:= bsClear;
      if (s = 'Name') and (GetOffset(i) = 0) then
        Font.Style:= [fsBold];
      TextRect(R, x, y, s);
    end;
  end;
...
procedure TfrxObjectInspector.FormCreate(Sender:TObject);
begin
  frxResources.LocalizeForm(Self);
end;
...
begin
  Tab.Width:= ClientWidth+10;
  Tab.Height:= ClientHeight-Tab.Top+2;
  BackPanel.Width:= ClientWidth;
  BackPanel.Height:= Tab.ClientHeight-26;
