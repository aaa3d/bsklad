...
uses
  ...
  ppRelatv, ppModule, ppViewr, ppForms, daDatMod, daDB, daDBBDE, daDatMan,
  daQClass, daQuery, ppTypes;
...
begin
  ...
  ppReport1.CreateAutoSearchCriteria('plOrders', 'SaleDate', soBetween, '1/1/1990,12/31/1995', False);
