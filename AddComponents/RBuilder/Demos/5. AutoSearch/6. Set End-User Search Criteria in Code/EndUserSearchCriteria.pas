...
uses
  ...
  ppProd, ppClass, ppReport, ppTypes, ppModule, daDatMod, ppCtrls, ppVar,
  ppPrnabl, ppBands, ppDBBDE, daDataVw, daQuery, daDBBDE, daQClass,
  Buttons, ExtCtrls, ppEndUsr, daDatMan;
...
type
  TForm1 = class(TForm)
    ...
    ppLabel9: TppLabel;
    plCustomers: TppChildBDEPipeline;
