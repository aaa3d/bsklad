...
uses
  ...
  Buttons, Tabs, IniFiles, dmUtil, dmLevels, ppViewr, ppTypes, Mask,
  ppForms, dmPrvw, ppPrvDlg, ppUtils;
...
{$IFDEF ppTeeChart}
  dm0092,
{$ENDIF}
  dm0101, dm0102, dm0103, dm0104, dm0105, dm0106, dm0107,
...
begin
  tblDemo.SetRangeStart;
  tblDemo.FieldByName('Level').AsInteger := aStart;

  tblDemo.SetRangeEnd;
  tblDemo.FieldByName('Level').AsInteger := aEnd;
