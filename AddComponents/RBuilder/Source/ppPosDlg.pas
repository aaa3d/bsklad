...
uses
  ...
  Dialogs, ppForms, ppTypes, ppUtils, ComCtrls;

type

  TppPosType = (ppptLeft, ppptTop, ppptWidth, ppptHeight, ppptBottomOffset,
                ppptOverFlowOffset, ppptStopPosition);
...
{------------------------------------------------------------------------------}
{ TppPositionDialog.Activate }

procedure TppPositionDialog.Activate;
begin
