...
{$IFDEF WINDOWS}  {note: this needs to be declared here for Delphi 1 compiler}

  procedure ppRegisterComponentHandler(aComponentClass: TppComponentClass;
                                     const aToolBarName: String;
                                     aToolBarPosition: Integer;
                                     aHintIndex: Integer;
                                     const aHint: String;
  ...
  procedure ppUnRegisterComponentHandler(aComponentClass: TppComponentClass);
