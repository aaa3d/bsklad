...
type
  ...
  TppLabelSet = class
    protected
      class function GetLabelDef(aIndex: Integer): String; virtual; abstract;

    public
      class function Product: String; virtual; abstract;
      class function PrinterType: TppLabelPrinterType; virtual; abstract;
