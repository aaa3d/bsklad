...
uses
  Windows, SysUtils, Classes, Graphics, Forms, Controls, Buttons,
  StdCtrls, ExtCtrls, Dialogs, ppForms, ppTypes, ppUtils, ppReport;
...
begin
  ...
  lblCalcOn.Caption     := ppLoadStr(504); {Calculate On}
  lblResetOn.Caption    := ppLoadStr(501); {Reset On}
