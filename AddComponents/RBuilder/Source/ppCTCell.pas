...
const
  ...
  ppNumerics = [dtDate, dtTime, dtDateTime, dtInteger, dtSingle, dtDouble, dtExtended, dtCurrency, dtLongint];
...
begin
  ...
  case aVarType of
    varSmallint, varInteger: Result := dtInteger;
    varSingle, varDouble: Result := dtExtended;
    varCurrency: Result := dtCurrency;
    varDate: Result := dtDateTime;
    varString: Result := dtString;
...
function ppStringToCaption(aValue: String): String;
begin
  if (Length(ppAllTrim(aValue)) = 0) then
