...
uses
  ...
  DB, DBISAMTb, ExtCtrls, StdCtrls, FR_Const;

type
  TfrDBIFieldsLinkForm = class(TForm)
    DetailL: TListBox;
    MasterL: TListBox;
    Label1: TLabel;
    Label2: TLabel;
...
procedure TfrDBIFieldsLinkForm.FillLists;
var
  i: Integer;
  s: String;
begin
...
procedure TfrDBIFieldsLinkForm.FormShow(Sender: TObject);
var
  i: Integer;
begin
...
procedure TfrDBIFieldsLinkForm.FormHide(Sender: TObject);
begin
...
procedure TfrDBIFieldsLinkForm.ClearBClick(Sender: TObject);
begin
  FCurFields := '';
  FillLists;
end;

procedure TfrDBIFieldsLinkForm.DetailLDrawItem(Control: TWinControl;
...
procedure TfrDBIFieldsLinkForm.DetailLClick(Sender: TObject);
begin
...
procedure TfrDBIFieldsLinkForm.MasterLClick(Sender: TObject);
begin
  if DetailL.ItemIndex <> -1 then
    AddB.Enabled := True;
end;

procedure TfrDBIFieldsLinkForm.AddBClick(Sender: TObject);
var s: String;
begin
...
procedure TfrDBIFieldsLinkForm.Localize;
begin
...
procedure TfrDBIFieldsLinkForm.FormCreate(Sender: TObject);
begin
  Localize;
end;
