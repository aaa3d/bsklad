...
uses
  Windows, SysUtils, Classes, DB, FR_Class, FR_Utils, FR_DBRel, FR_Pars;
...
begin
  ...
  begin
    for i := 0 to FCellFields.Count - 1 do
    begin
      f := TfrTField(FDataSet.FindField(PureName(FCellFields[i])));
